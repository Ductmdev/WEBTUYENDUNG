            ...
            <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-start mt-md-4 mt-3">
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-center justify-content-md-start">
                        <h1 style="font-family: Inter, sans-serif; font-size: 30px; color: white;" >TOPDEV</h1>
                    </div>
                    <div class="col-12 ">
                        <div class="row d-flex justify-content-center justify-content-md-start mb-3 mt-2">
                            <div class="col-2">
                                <a href="https://www.facebook.com/duw0703/" target="_blank"><i class="fa-brands fa-facebook fa-xl" style="color: #ffffff;"></i></a>
                            </div>
                            <div class="col-2">
                                <a href="https://github.com/Ductmdev" target="_blank"><i class="fa-brands fa-github fa-xl" style="color: #ffffff;"></i></a>
                            </div>
                            <div class="col-2">
                                <a href="https://www.youtube.com/@Duwwz" target="_blank"> <i class="fa-brands fa-youtube fa-xl" style="color: #ffffff;"></i></a>
                            </div>
                        </div>

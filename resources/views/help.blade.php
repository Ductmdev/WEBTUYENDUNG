...
@section('content')
    <div class="container">
        ...
        <p>Xin chào và chào mừng bạn đến với trang hướng dẫn của TOPDEV! Dưới đây là một số hướng dẫn cơ bản để bạn bắt đầu:</p>
        ...
        <p>Đây chỉ là những hướng dẫn cơ bản. Chúng tôi hy vọng rằng trang hướng dẫn này sẽ giúp bạn có một trải nghiệm tốt khi sử dụng TOPDEV!</p>

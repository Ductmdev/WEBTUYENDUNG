...
{{--                                Học vấn--}}
                                ...
                                <div style="width: 252px; height: 71px; margin-top: 45px; position: absolute" > <p style=" font-size: 9.8pt; color: #0C3149"><span style="font-family: Nunito;"><b><input name="school-1" value="Tốt Nghiệp Đại Học CNGTVT"></b><textarea name="des-school-1"> - Đại Học Công Nghệ Giao Thông Vận Tải</textarea></span><br><span style="font-family: Nunito;"><b><input name="school-2" value="Tốt Nghiệp Đại Học CNGTVT"></b><textarea name="des-school-2">- Đại Học Công Nghệ Giao Thông Vận Tải</textarea> </span></p></div>
